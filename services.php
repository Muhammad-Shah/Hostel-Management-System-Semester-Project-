    ...
    <div class="container-fluid">
        <div class="banner_bottom_agile_grids">
            <div class="row wthree_banner_bottom_right_grids pr-sm-3">
                <div class="col-lg-4 col-sm-6 banner_bottom_right_grid"> <!-- Changed col-lg-3 to col-lg-4 -->
                    <div class="view view-tenth">
                        <div class="agile_text_box">
                            <i class="fas fa-bed" aria-hidden="true"></i>
                            <h3> Apply for Abdali Boys Hostle</h3>
								<p>Boys Hostel - A</p>
                        </div>
                        <div class="mask">
                ...
                <div class="col-lg-4 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid"> <!-- Changed col-lg-3 to col-lg-4 -->
				...
				<div class="col-lg-4 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid"> <!-- Changed col-lg-3 to col-lg-4 -->
                    <div class="view view1 view-tenth">
                        <div class="agile_text_box">
                            <i class="fas fa-bed" aria-hidden="true"></i>
                            <h3>Apply for Aysesha Girls Hostle</h3>
                            <p>Girls Hostel</p>
                        </div>
                        <div class="mask">
