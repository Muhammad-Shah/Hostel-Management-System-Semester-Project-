    ...
    <div class="container-fluid">
        <div class="banner_bottom_agile_grids">
            <div class="row wthree_banner_bottom_right_grids pr-sm-3">
                <div class="col-lg-4 col-sm-6 banner_bottom_right_grid">
                    <div class="view view-tenth">
                        <div class="agile_text_box">
                            <i class="fas fa-bed" aria-hidden="true"></i>
                            <h3>Apply for Abdali Hostle-Mess</h3>
                            <p>Boys Hostel Mess</p>
                        </div>
                        <div class="mask">
                ...
                <div class="col-lg-4 col-sm-6 mt-sm-0 mt-3 banner_bottom_right_grid">
                    <div class="view view1 view-tenth">
                        <div class="agile_text_box">
                            <i class="fas fa-bed" aria-hidden="true"></i>
                            <h3>Apply for Ahmad Khan Hostle-Mess</h3>
                            <p>Boys Hostel Mess</p>
                        </div>
                        <div class="mask">
                ...
                <div class="col-lg-4 col-sm-6 mt-lg-0 mt-3 banner_bottom_right_grid">
                    <div class="view view2 view-tenth">
                        <div class="agile_text_box">
                            <i class="fas fa-bed" aria-hidden="true"></i>
                            <h3>Apply for Ayesha Hostle-Mess</h3>
                            <p>Girls Hostel Mess</p>
                        </div>
                        <div class="mask">
